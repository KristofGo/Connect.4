...
public class Constants
{
    ...
    public static final int CHECK_IF_WINNER = 8;
    public static final int CHECK_IF_TIE = 40;
    public static final int X_WINS = 41;
    ...
    //FIXME : Update string to represent Connect 4 columns
